...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const menuItems = [
    {
      ...
      icon: "fas fa-tasks",
      description: "Manage tasks for maintenance activities.",
      link: "/mgmt-task",
    },
    {
      title: "Equipment Management",
      icon: "fas fa-tools",
      description: "View and manage maintenance equipment.",
      link: "/mgmt-equipment",
    },
    {
      ...
      link: "/mgmt-user-employee",
    },
    {
      title: "Document Management",
      icon: "fas fa-file-alt",
      description: "View and manage maintenance documents.",
      link: "/mgmt-document",
    },
    {
      ...
      link: "/mgmt-training-module",
    },
    {
      title: "Access Provisioning Management",
      icon: "fas fa-universal-access",
      description: "Access provisioning modules.",
      link: "/mgmt-access",
    },
    {
      title: "User Access Management",
      icon: "fas fa-user-check",
      description: "User Access modules.",
      link: "/mgmt-user-access",
    },
  ];
  ...
  menuItems.forEach((item) => {
    ...
    card.innerHTML = `
            <div class="card p-4 text-center animate__animated animate__bounceInUp" data-link="${item.link}">
                <i class="${item.icon}"></i>
