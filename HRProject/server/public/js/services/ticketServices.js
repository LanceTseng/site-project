...
export const getTicketsByCondition = async (condition) => {
    try {
        const response = await axiosInstance.get(`${view.ticketView}condition?`, { params: condition });
        return response.data;
    } catch (error) {
...
export const getAllTicketHeadView = async () => {
    try {
        const response = await axiosInstance.get(`${view.ticketView}head`);
        return response.data;
    } catch (error) {
        console.error("Error fetching tickets:", error);
        throw error;
...
export const getTicketHeadViewByCondition = async (condition) => {
    try {
        const response = await axiosInstance.get(`${view.ticketView}head/condition?`, {params: condition});
        return response.data;
    } catch (error) {
        console.error("Error fetching tickets:", error);
        throw error;
